...
With this, the velocity update can be implemented using the \pyinline{numpy.einsum} function, which implements the Einstein notation. This provides the advantage of avoiding costly Python loops and using vectorized NumPy code instead.
